...
const BriefingCard: React.FC<BriefingCardProps> = ({ title, icon, children, isNote = false }) => (
    <div className="bg-slate-50 p-6 rounded-xl border border-slate-200/80 min-h-[20rem] flex flex-col">
