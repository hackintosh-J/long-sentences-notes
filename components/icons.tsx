...
export const MedicineIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.25h.008v.008H12v-.008zm0 3h.008v.008H12v-.008zm-2.25-1.5h.008v.008H9.75v-.008zm4.5 0h.008v.008h-.008v-.008z" />
    </svg>
);
...
export const SpinnerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="animate-spin" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v3m0 12v3m9-9h-3m-12 0H3m16.03-6.03L16.5 7.5m-9 9l-1.53 1.53M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const FeatherIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a12.022 12.022 0 01-11.68 0M12 2.25A12.022 12.022 0 0123.75 12c0 3.235-1.28 6.18-3.37 8.39" />
    </svg>
);
...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c.34.02.67.06.99.1v0a6.75 6.75 0 01.99 11.26.75.75 0 00.58.26h.23a.75.75 0 00.72-.92 8.25 8.25 0 00-2.5-5.98M12 2.25c-.34.02-.67.06-.99.1v0a6.75 6.75 0 00-.99 11.26.75.75 0 01-.58.26h-.23a.75.75 0 01-.72-.92 8.25 8.25 0 012.5-5.98M12 21.75c.34-.02.67-.06.99-.1v0a6.75 6.75 0 00.99-11.26.75.75 0 01.58-.26h.23a.75.75 0 01.72.92 8.25 8.25 0 01-2.5 5.98M12 21.75c-.34-.02-.67-.06-.99-.1v0a6.75 6.75 0 01-.99-11.26.75.75 0 00-.58-.26h-.23a.75.75 0 00-.72.92 8.25 8.25 0 002.5 5.98M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
